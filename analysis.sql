...
-- List of movies released in a specific year (e.g., 2020)
...
-- country column has multiple country names in one record, so we will separate and get the unique records
SELECT 
...
-- Movies in actor 'Salman Khan' appeared in last 10 years!
SELECT *
FROM netflix
WHERE type = 'Movie' 
	  AND
